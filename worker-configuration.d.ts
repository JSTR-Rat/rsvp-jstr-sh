/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8f28f9c0719a819756dc297e85ced72)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		BETTER_AUTH_URL: "https://staging.wada.wedding" | "https://wada.wedding" | "http://localhost:5173";
		BETTER_AUTH_SECRET: string;
		TURNSTILE_SECRET_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}

...
export const Route = createFileRoute(
  ...
  head: () => ({
    meta: [{ title: 'Dev — Wedding invite (production template) preview' }],
  }),
});
  ...
  return (
    <div className="min-h-svh p-6">
      <p className="mb-4 font-sans text-sm text-amber-200/90">
        Dev-only preview — same markup as Resend (`WeddingInviteStationeryHeroEmail`).
        The photo hero was removed for Gmail compatibility; this matches the dark
        stationery shell.
      </p>
